...
extern ge211::Color const ship_color, missile_color, enemy_color, ship_missile_color;
...
struct Ui : ge211::Abstract_game
{
    ...
    ge211::Circle_sprite const
            missile_sprite_   {model_.get_geometry().missile_radius, missile_color};

    ge211::Font const sans {ge211::Font("sans.ttf", 24)};

    ge211::Text_sprite time_sprite_
            {model_.get_time_(), sans};
